...
## App View
<div style="display: grid; grid-template-columns: repeat(4, 1fr); grid-template-rows: 50% 50%; gap: 0.7em;" class="image-container">
  <img style="max-width: 10%; height: auto;" src="images/homesgrid.PNG" alt="homes grid">
